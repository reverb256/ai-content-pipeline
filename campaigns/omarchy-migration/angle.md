...
```
reader: the technical operator or Linux-curious gamer who has thought about
        "should I leave Windows?" — scared of the wipe, curious about the
...
sections:
  ...
  6. The payoff: the personal autonomous corporation (Hermes fleet, memlawb,
     kanban, CDP browser)
  7. What I'd do differently (v2): the honest list (target the right disk,
